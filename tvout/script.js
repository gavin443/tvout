var TransferOutWidget = /** @class */ (function () {
    ...
    TransferOutWidget.prototype.validateOptions = function () {
        ...
        var canShow = ((_a = (document.querySelector("[data-transferpage='" + this.pageCount + "'] input[name^=\"request-\"]:checked"))) === null || _a === void 0 ? void 0 : _a.dataset.text) == "true";
        var noneChecked = document.querySelectorAll("[data-transferpage='" + this.pageCount + "'] input[name^=\"request-\"]:checked").length > 0;
        ...
        switch (this.pageCount) {
            case 0:
                (_c = (document.querySelector("[data-transferbtn='" + this.pageCount + "'].request"))) === null || _c === void 0 ? void 0 : _c.classList.toggle("d-none", canShow);
                (_d = (document.querySelector("[data-transferbtn='" + this.pageCount + "'].next-section"))) === null || _d === void 0 ? void 0 : _d.classList.toggle("d-none", !canShow);
                break;
            case 3:
                (_e = (document.querySelector("[data-transferpage='" + this.pageCount + "'] .read-more"))) === null || _e === void 0 ? void 0 : _e.classList.toggle("d-none", !canShow);
                (_f = (document.querySelector("[data-transferbtn='" + this.pageCount + "'].next-section"))) === null || _f === void 0 ? void 0 : _f.classList.toggle("d-none", canShow);
                break;
            default:
                console.log(document.querySelector("[data-transferbtn='" + this.pageCount + "'].next-section"));
                (_g = (document.querySelector("[data-transferbtn='" + this.pageCount + "'].next-section"))) === null || _g === void 0 ? void 0 : _g.classList.toggle("d-none", !noneChecked);
                break;
        }
    };
    TransferOutWidget.prototype.setupListeners = function () {
        ...
        this.turnSection.forEach(function (node) {
            node.addEventListener("click", function (e) {
                var _a, _b;
                (document.querySelector("[data-transferpage='" + _this.pageCount + "']")).classList.add("d-none");
                ...
                (_b = (document.querySelector("[data-transferpage='" + _this.pageCount + "']"))) === null || _b === void 0 ? void 0 : _b.classList.remove("d-none");
            });
        });
    };
